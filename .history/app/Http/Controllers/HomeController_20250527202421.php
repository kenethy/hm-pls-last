...
class HomeController extends Controller
{
    public function index()
    {
        ...
        // Get featured spare parts for homepage
        $featuredSpareParts = SparePart::active()
            ->featured()
            ->with('category')
            ->ordered()
            ->limit(4)
        ...
        // Get spare part categories for homepage
        $sparePartCategories = SparePartCategory::active()
            ->ordered()
        ...
        return view('pages.home', [
            ...
            'featuredSpareParts' => $featuredSpareParts,
