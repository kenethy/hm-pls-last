...
class Service extends Model
{
    ...
    /**
     * Get the customer name with license plate for display in select options.
     */
    public function getCustomerNameWithLicensePlateAttribute(): string
    {
        return "{$this->customer_name} - {$this->license_plate}";
    }
}
