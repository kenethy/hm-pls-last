            ...
            ->renderHook(
                ...
                function () {
                    return view('components.rating-modal') .
                        '<script src="' . asset('js/mechanic-rating.js') . '?v=' . time() . '"></script>' .
                        '<div style="position: fixed; top: 10px; right: 10px; z-index: 9999;">
                            <button onclick="checkSessionRatingTriggers()" style="background: #f59e0b; color: white; padding: 8px 12px; border: none; border-radius: 4px; font-size: 12px; cursor: pointer;">
                                🔍 Check Rating Triggers
                            </button>
                            <button onclick="testRatingModal()" style="background: #10b981; color: white; padding: 8px 12px; border: none; border-radius: 4px; font-size: 12px; cursor: pointer; margin-left: 5px;">
                                🧪 Test Modal
                            </button>
                        </div>
                        <script>
                            function testRatingModal() {
                                ...
                                if (window.ratingSystem) {
                                    window.ratingSystem.openRatingModal(1);
                                } else {
                                    alert("Rating system not available");
                                }
                            }
                        </script>';
                }
