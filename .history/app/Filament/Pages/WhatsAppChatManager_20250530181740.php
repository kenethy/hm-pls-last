...
class WhatsAppChatManager extends Page
{
    ...
    protected static ?string $slug = 'whatsapp-chat-manager';
    ...
    public function mount(): void
    {
        ...
        // Lazy load - only check status and load chats when needed
        $this->dispatch('lazy-load-whatsapp');
    }

    public function lazyLoadWhatsApp(): void
    {
