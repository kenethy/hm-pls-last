                ...
                Forms\Components\Section::make('Konten Template')
                    ->schema([
                        Forms\Components\RichEditor::make('content')
                            ...
                            ->helperText('Gunakan variabel di bawah ini untuk menambahkan data dinamis ke template. Gunakan paragraf dan line breaks untuk format yang baik di WhatsApp.')
                            ->columnSpanFull(),
