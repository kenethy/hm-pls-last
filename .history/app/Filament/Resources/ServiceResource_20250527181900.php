    ...
    public static function beforeSave(Forms\Form $form): void
    {
        ...
        if ($form->model->status === 'completed') {
            ...
            if ($form->model->mechanics()->count() === 0) {
                ...
                // 🎯 CRITICAL FIX: Trigger rating modal for edit form completion
                Log::info('🎯 Service completed via edit form, triggering rating modal for service: ' . $form->model->id);
                static::triggerRatingModal($form->model);
