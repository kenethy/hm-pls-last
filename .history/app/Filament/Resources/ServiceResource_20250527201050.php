            ...
            ->actions([
                ...
                Tables\Actions\Action::make('markAsCompleted')
                    ...
                    ->action(function (array $data, Service $record) {
                        ...
                        // ✅ Simple notification - rating button will be in table
                        Notification::make()
                            ->title('✅ Servis Selesai')
                            ->body("Servis untuk {$record->customer_name} telah selesai. Gunakan tombol 'Rating Montir' di tabel untuk memberikan rating.")
                            ->success()
                            ->persistent()
                            ->send();
                    }),
