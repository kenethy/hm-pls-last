        ...
        return $table
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('generateDigitalReport')
                    ...
                    ->color('primary')
                    ->visible(fn(Service $record) => $record->status === 'completed' && $record->service_type === 'Tune Up Mesin')
                    ->action(function (Service $record) {
                        ...
                        if (!$template) {
                            Notification::make()
                                ...
                                ->body('Template laporan digital tidak ditemukan. Silakan buat template terlebih dahulu.')
                                ->danger()
                                ->send();
                            return;
                        }
                        ...
                        // Create the report
                        $report = $template->createServiceReport($record);
