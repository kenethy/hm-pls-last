                    ...
                    ->after(function ($record) {
                        ...
                        if ($record->sent_to_customer) {
                            ...
                            if ($record->image_path) {
                                $imageUrl = $record->getWhatsAppImageUrl();
                                if ($imageUrl) {
                            ...
                            Notification::make()
                                ->title('Klik di sini untuk membuka WhatsApp')
                                ->body('Pesan telah disiapkan dan siap dikirim')
                                ->actions([
                                    NotificationAction::make('open_whatsapp')
                                        ->label('Buka WhatsApp')
                                        ->url($whatsappUrl)
                                        ->openUrlInNewTab()
                                ])
