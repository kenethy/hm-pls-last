            ...
            ->actions([
                ...
                Tables\Actions\Action::make('markAsCompleted')
                    ...
                    ->action(function (array $data, Service $record) {
                        ...
                        // 🚀 NEW APPROACH: Direct JavaScript injection for rating modal
                        static::injectRatingModalScript($record);

                        Notification::make()
                            ->title('✅ Servis Selesai')
                            ->body("Servis untuk {$record->customer_name} telah selesai. Modal rating akan muncul sebentar lagi.")
                            ->success()
                            ->persistent()
                            ->send();
                    }),
