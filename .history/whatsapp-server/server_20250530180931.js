...
app.get('/chats/list', async (req, res) => {
    ...
    try {
        console.log('🔍 Getting chats from WhatsApp Web.js...');
            ...
            try {
                ...
                if (!chat.isGroup && chat.id.user) {
                    try {
                        ...
                        contactName = contact.name || contact.pushname || chat.id.user;
                    } catch (e) {
                        console.log('Could not get contact info for', chat.id.user);
                    }
                }

                return {
                    id: chat.id._serialized,
                    name: contactName || chat.id.user || 'Unknown',
                    ...
                    profilePic: null // Will be populated separately if needed
                };
            } catch (error) {
