    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
            <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <div class="mt-4">
                    <a href="{{ route('filament.admin.resources.galleries.index') }}"
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <div class="mt-4">
                    <a href="{{ route('filament.admin.resources.galleries.index') }}?tableFilters[is_featured][value]=true"
                        class="text-sm font-medium text-primary-600 hover:text-primary-500">
                        Lihat foto unggulan
                    </a>
                </div>
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <div class="mt-4">
                    <a href="{{ route('filament.admin.resources.gallery-categories.index') }}"
                        class="text-sm font-medium text-primary-600 hover:text-primary-500">
                        Kelola kategori
                    </a>
                </div>
            ...
            <div class="col-span-2 rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <div class="mt-4 grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
                    ...
                    <div class="group relative overflow-hidden rounded-lg">
                        ...
                        <div
                            class="absolute bottom-0 left-0 right-0 p-2 text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                            <p class="truncate text-xs font-medium">{{ $photo->title }}</p>
                        </div>
                        <a href="{{ route('filament.admin.resources.galleries.edit', $photo) }}"
                            class="absolute inset-0" aria-label="Edit {{ $photo->title }}"></a>
                    </div>
                    @empty
                ...
                <div class="mt-4 space-y-4">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <div
                                class="flex h-10 w-10 items-center justify-center rounded-full bg-primary-50 text-primary-500">
                        ...
                        <div class="flex items-center">
                            <span class="rounded-full bg-primary-50 px-2.5 py-0.5 text-xs font-medium text-primary-700">
                                {{ $category->gallery_items_count }} foto
                            </span>
                        </div>
                    </div>
                    @empty
        ...
        <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-4">
                <a href="{{ route('filament.admin.resources.galleries.create') }}"
                    class="flex items-center rounded-lg border border-gray-200 bg-white p-4 shadow-sm transition-all hover:bg-gray-50 hover:shadow">
                    <div
                        class="mr-4 flex h-10 w-10 items-center justify-center rounded-full bg-primary-50 text-primary-500">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                ...
                <a href="{{ route('admin.simple-gallery') }}"
                    class="flex items-center rounded-lg border border-gray-200 bg-white p-4 shadow-sm transition-all hover:bg-gray-50 hover:shadow">
                    <div
                        class="mr-4 flex h-10 w-10 items-center justify-center rounded-full bg-amber-50 text-amber-500">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="h-5 w-5">
                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <a href="{{ route('filament.admin.resources.gallery-categories.index') }}"
                    class="flex items-center rounded-lg border border-gray-200 bg-white p-4 shadow-sm transition-all hover:bg-gray-50 hover:shadow">
                    <div
                        class="mr-4 flex h-10 w-10 items-center justify-center rounded-full bg-green-50 text-green-500">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="h-5 w-5">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6zM3.75 15.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18v-2.25zM13.5 6a2.25 2.25 0 012.25-2.25H18A2.25 2.25 0 0120.25 6v2.25A2.25 2.25 0 0118 10.5h-2.25a2.25 2.25 0 01-2.25-2.25V6zM13.5 15.75a2.25 2.25 0 012.25-2.25H18a2.25 2.25 0 012.25 2.25V18A2.25 2.25 0 0118 20.25h-2.25A2.25 2.25 0 0113.5 18v-2.25z" />
