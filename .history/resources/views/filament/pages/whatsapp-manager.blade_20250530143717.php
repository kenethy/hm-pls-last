                ...
                @if($sessionStatus)
                    <div class="mt-4">
                        <div class="text-sm text-gray-600 dark:text-gray-300">
                            ...
                            <pre class="mt-2 p-3 bg-gray-50 dark:bg-gray-700 rounded text-xs overflow-auto">{{ json_encode($sessionStatus, JSON_PRETTY_PRINT) }}</pre>
                        </div>
                    </div>
                @endif
            </div>
                ...
                <div class="px-4 py-5 sm:p-6">
                    <div class="text-center">
                        <div class="mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-green-100 dark:bg-green-800 mb-4">
                            <svg class="h-6 w-6 text-green-600 dark:text-green-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="space-y-4 text-sm text-gray-600 dark:text-gray-300">
                    <div class="flex items-start space-x-3">
                        <div class="flex-shrink-0">
                            <span class="inline-flex items-center justify-center h-6 w-6 rounded-full bg-blue-100 dark:bg-blue-800 text-blue-600 dark:text-blue-200 text-xs font-medium">1</span>
                        </div>
                        <div>
                            <p><strong>Mulai Sesi:</strong> Klik tombol "Start Session" untuk memulai koneksi WhatsApp.</p>
                        </div>
                    </div>
                    
                    <div class="flex items-start space-x-3">
                        <div class="flex-shrink-0">
                            <span class="inline-flex items-center justify-center h-6 w-6 rounded-full bg-blue-100 dark:bg-blue-800 text-blue-600 dark:text-blue-200 text-xs font-medium">2</span>
                        </div>
                        <div>
                            <p><strong>Scan QR Code:</strong> Gunakan WhatsApp di ponsel untuk scan QR code yang muncul.</p>
                        </div>
                    </div>
                    
                    <div class="flex items-start space-x-3">
                        <div class="flex-shrink-0">
                            <span class="inline-flex items-center justify-center h-6 w-6 rounded-full bg-blue-100 dark:bg-blue-800 text-blue-600 dark:text-blue-200 text-xs font-medium">3</span>
                        </div>
                        <div>
                            <p><strong>Test Pesan:</strong> Setelah terhubung, gunakan "Test Message" untuk menguji pengiriman.</p>
                        </div>
                    </div>
                    
                    <div class="flex items-start space-x-3">
                        <div class="flex-shrink-0">
                            <span class="inline-flex items-center justify-center h-6 w-6 rounded-full bg-blue-100 dark:bg-blue-800 text-blue-600 dark:text-blue-200 text-xs font-medium">4</span>
                        </div>
                        <div>
                            <p><strong>Follow-up Otomatis:</strong> Gunakan "Send Follow-up Messages" untuk mengirim pesan follow-up ke pelanggan.</p>
                        </div>
                    </div>
                </div>
