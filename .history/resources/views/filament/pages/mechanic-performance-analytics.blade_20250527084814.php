<x-filament-panels::page>
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <div class="mt-4">
                <p class="text-sm font-medium text-gray-700 mb-2">Rentang Tanggal Cepat:</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-500">Total Rating</p>
                        <p class="text-2xl font-semibold text-gray-900">{{ $ratingStatistics['total_ratings'] }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ $ratingStatistics['average_rating'] }}/5</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ $ratingStatistics['satisfaction_rate'] }}%
                        </p>
                    </div>
                </div>
            </div>
