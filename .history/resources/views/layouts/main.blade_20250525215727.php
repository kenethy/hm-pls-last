...
<head>
    ...
    <!-- Favicon and App Icons - Optimized for Google Search Results -->
    <!-- Primary favicon for Google search results (16x16) -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('favicon/favicon-16x16.png') }}?v=20241201-hq">
    <!-- Standard favicon for browser tabs (32x32) -->
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('favicon/favicon-32x32.png') }}?v=20241201-hq">
    <!-- Enhanced scaling favicon (48x48) -->
    <link rel="icon" type="image/png" sizes="48x48" href="{{ asset('favicon/favicon-48x48.png') }}?v=20241201-hq">
    <!-- High DPI displays (96x96) -->
    <link rel="icon" type="image/png" sizes="96x96" href="{{ asset('favicon/favicon-96x96.png') }}?v=20241201-hq">
    <!-- Legacy ICO support -->
    <link rel="icon" href="{{ asset('favicon.ico') }}?v=20241201-hq" type="image/x-icon">
    <link rel="shortcut icon" href="{{ asset('favicon.ico') }}?v=20241201-hq" type="image/x-icon">
    <!-- Apple Touch Icon -->
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('favicon/apple-touch-icon.png') }}?v=20241201-hq">
    <!-- Web App Manifest -->
    <link rel="manifest" href="{{ asset('site.webmanifest') }}?v=20241201-hq">
    <!-- Safari Pinned Tab -->
    <link rel="mask-icon" href="{{ asset('favicon/safari-pinned-tab.svg') }}?v=20241201-hq" color="#e11d48">
    <!-- Microsoft Tiles -->
    <meta name="msapplication-TileColor" content="#e11d48">
    <meta name="msapplication-TileImage" content="{{ asset('favicon/mstile-150x150.png') }}?v=20241201-hq">
    ...
    <link rel="preload" href="{{ asset('css/testimonial-carousel-new.css') }}" as="style"
        onload="this.onload=null;this.rel='stylesheet'">
    <noscript>
        <link rel="stylesheet" href="{{ asset('css/testimonial-carousel-new.css') }}">
    </noscript>

    <link rel="preload" href="{{ asset('css/testimonial-carousel-modern.css') }}" as="style"
        onload="this.onload=null;this.rel='stylesheet'">
    <noscript>
        <link rel="stylesheet" href="{{ asset('css/testimonial-carousel-modern.css') }}">
    </noscript>
