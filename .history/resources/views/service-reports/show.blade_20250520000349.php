            ...
            <div class="bg-gray-100 rounded-lg p-6 mb-6">
                <div class="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div class="text-center md:text-right">
                        ...
                        <p class="text-gray-600 text-sm mb-1">Jl. Contoh No. 123, Yogyakarta</p>
                        <p class="text-gray-600 text-sm mb-1">Telp: 0812-3456-7890</p>
                        <p class="text-gray-600 text-sm">Email: info@hartonomotor.com</p>
                    </div>
                </div>
            </div>
