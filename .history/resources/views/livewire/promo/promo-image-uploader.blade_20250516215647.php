<div class="w-full">
    <div class="space-y-4">
        ...
        <div class="relative">
            <img src="{{ $imageUrl }}" alt="Promo Image Preview"
        ...
        <div class="space-y-2">
            ...
            <input type="file" id="promo-image-{{ rand() }}" wire:model="image" accept="image/*" class="block w-full text-sm text-gray-500
        ...
        <div class="mt-2">
            <div class="flex items-center justify-center">
                <div class="w-full bg-gray-200 rounded-full h-2.5">
                    <div class="upload-progress bg-primary-600 h-2.5 rounded-full text-xs text-center text-white"
                        style="width: 0%">0%</div>
                </div>
            </div>
        </div>
