        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <div class="flex space-x-4">
                    <!-- Social Media Icons -->
                    <a href="https://instagram.com/hartonomotorsidoarjo" target="_blank" aria-label="Instagram Hartono Motor"
                    ...
                    <a href="https://facebook.com/hartonomotorsidoarjo" target="_blank" aria-label="Facebook Hartono Motor"
                        class="text-white hover:text-red-500 transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24"
                            aria-hidden="true">
                            <path
                    ...
                    <a href="https://tiktok.com/@hartonomotorsidoarjo" target="_blank" aria-label="TikTok Hartono Motor"
                        class="text-white hover:text-red-500 transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24"
                            aria-hidden="true">
                            <path
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="https://shopee.co.id/hartono_motor" target="_blank"
                            class="text-gray-300 hover:text-white transition-colors">Shopee</a></li>
                    <li><a href="https://www.lazada.co.id/shop/hartono-motor-sidoarjo/?spm=a2o4j.pdp_revamp.seller.1.3efb7b46zHzsFf&itemId=8407228578&channelSource=pdp"
                            target="_blank" class="text-gray-300 hover:text-white transition-colors">Lazada</a></li>
                </ul>
            </div>
