...
<!-- Individual Mechanic Rating Template - Minimalis -->
<template id="mechanicRatingTemplate">
    <div
        class="mechanic-rating-card bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
        <!-- Mechanic Header - Minimalis -->
        <div class="flex items-center justify-between mb-4">
            <div>
                <h4 class="mechanic-name text-sm font-medium text-gray-900 dark:text-white"></h4>
                <p class="mechanic-specialization text-xs text-gray-500 dark:text-gray-400"></p>
            </div>
            <div
                class="rating-status-badge text-xs px-2 py-1 rounded-full bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300">
                Belum Rating
            </div>
        </div>
        ...
        <div class="rating-section">
            ...
            <div class="mb-3">
                ...
                <div class="star-rating flex items-center gap-x-1" data-mechanic-id="">
                    <button type="button" class="star transition-all duration-200 hover:scale-110 focus:outline-none"
                        data-rating="1">
                        <svg class="h-7 w-7 text-gray-300 hover:text-amber-400 transition-colors duration-200"
            ...
            <div class="flex justify-end">
                <button type="button"
                    class="submit-individual-rating px-4 py-2 bg-amber-600 hover:bg-amber-500 text-white text-sm font-medium rounded-lg transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
