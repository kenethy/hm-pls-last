        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-gray-50 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                ...
                <div class="p-6">
                    ...
                    <div class="flex justify-between items-center">
                        <span class="text-red-600 font-bold">Mulai dari Rp 35.000</span>
            ...
            <div class="bg-gray-50 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                ...
                <div class="p-6">
                    ...
                    <div class="flex justify-between items-center">
                        <span class="text-red-600 font-bold">Mulai dari Rp 50.000</span>
                        <a href="{{ route('booking') }}"
                            class="bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-4 rounded-md transition-colors">Booking</a>
                    </div>
                </div>
            ...
            <!-- Service 6 -->
            <div class="bg-gray-50 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                <img src="{{ asset('images/service-6.jpg') }}" alt="Balancing" class="w-full h-64 object-cover"
                    loading="lazy">
                <div class="p-6">
                    <h3 class="text-2xl font-bold mb-3">Balancing</h3>
                    ...
                    <div class="flex justify-between items-center">
                        <span class="text-red-600 font-bold">Mulai dari Rp 25aga.000</span>
                        <a href="{{ route('booking') }}"
                            class="bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-4 rounded-md transition-colors">Booking</a>
                    </div>
                </div>
