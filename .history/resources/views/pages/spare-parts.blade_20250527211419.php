...
<!-- Pricing Notification Modal (Always Modal Now) -->
<div id="pricingModal" class="pricing-notification-modal">
    <div class="pricing-notification-content">
        <!-- Close Button -->
        <button onclick="closePricingModal()" class="modal-close-btn">
        ...
        <div class="modal-header">
            ...
            <h3 class="modal-title">{{ $pricingNotification['title'] }}</h3>
            <p class="modal-subtitle">{{ $pricingNotification['message'] }}</p>
        </div>

        <!-- Modal Body -->
        <div class="modal-body">
            <div class="price-comparison">
                <div class="price-item online">
                    <div class="price-label">Harga Online</div>
                    <div class="price-value">Rp 100.000</div>
                    <div class="price-note">+ Ongkir & Fee</div>
                </div>
                <div class="vs-divider">
                    <span>VS</span>
                </div>
                <div class="price-item offline">
                    <div class="price-label">Harga Toko</div>
                    <div class="price-value">Rp 85.000</div>
                    <div class="price-note">Hemat 15%!</div>
                </div>
            </div>
            ...
            <div class="benefits-list">
                <div class="benefit-item">
                    ...
                    <span>Harga lebih murah tanpa fee marketplace</span>
                </div>
                <div class="benefit-item">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                    ...
                    <span>Konsultasi langsung dengan ahli</span>
                </div>
                <div class="benefit-item">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                    ...
                    <span>Garansi dan after-sales service</span>
                </div>
            </div>
        </div>
        ...
        <div class="modal-footer">
            <a href="https://wa.me/{{ $pricingNotification['whatsapp_number'] }}?text=Halo Hartono Motor! Saya ingin menanyakan harga sparepart terbaik di toko. Mohon info detail harga dan ketersediaan produk. Terima kasih! 🙏"
                target="_blank" onclick="closePricingModal()" class="whatsapp-cta-button">
                ...
                <div class="button-content">
                    <span class="button-text">{{ $pricingNotification['cta_text'] }}</span>
                    <span class="button-subtext">Gratis konsultasi & penawaran terbaik</span>
                </div>
            </a>

            <button onclick="closePricingModal()" class="modal-dismiss-btn">
                Tutup
            </button>
        </div>
    </div>
