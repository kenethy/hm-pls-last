        ...
        <div class="max-w-4xl">
            ...
            <nav class="mb-6">
                <ol class="flex items-center space-x-2 text-sm">
                    ...
                    <li class="text-gray-400">/</li>
                    <li><a href="{{ route('spare-parts.category', $product->category->slug) }}" class="text-gray-300 hover:text-white">{{ $product->category->name }}</a></li>
                    <li class="text-gray-400">/</li>
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center justify-between">
                        @if($relatedProduct->original_price && $relatedProduct->original_price > $relatedProduct->price)
                            <div>
                                <span class="text-gray-400 line-through text-sm">{{ $relatedProduct->formatted_original_price }}</span>
