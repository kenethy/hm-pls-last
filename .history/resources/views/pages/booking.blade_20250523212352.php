...
<section class="relative bg-gray-900 text-white py-20">
    <div class="absolute inset-0 overflow-hidden">
        <img style="object-fit: cover; object-position: 0 20%; height: 300px;" src="{{ asset('images/hero-bg2.png') }}"
            alt="Booking Servis Hartono Motor" class="w-full h-full object-cover opacity-40">
    </div>
