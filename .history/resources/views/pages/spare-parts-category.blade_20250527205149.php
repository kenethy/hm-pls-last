                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                    ...
                    <div class="p-6">
                        <h3 class="text-lg font-bold mb-2">
                            <a href="{{ route('spare-parts.show', $product->slug) }}" class="hover:text-red-600 transition-colors">
                                {{ $product->name }}
                            </a>
                        </h3>
                        ...
                        <div class="flex items-center justify-between mb-4">
                            <div>
                                @if($product->original_price && $product->original_price > $product->price)
                                    <span class="text-gray-400 line-through text-sm">{{ $product->formatted_original_price }}</span>
        ...
        @else
            ...
            <div class="text-center py-16">
                <div class="max-w-md mx-auto">
                    ...
                    <a href="{{ route('spare-parts') }}" class="bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-4 rounded-lg transition-colors">
