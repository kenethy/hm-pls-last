...
<section class="py-16 bg-gradient-to-br from-gray-50 to-gray-100">
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            @forelse($featuredSpareParts as $index => $product)
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div>
                            ...
                            <span class="text-red-600 font-bold block">{{ $product->formatted_price }}</span>
                        </div>
                        @else
                        ...
                        <div class="flex space-x-2">
                            ...
                            <a href="{{ $marketplace['url'] }}" target="_blank"
                                ...
                                title="Beli di {{ $platform['name'] }}">
                                <span class="marketplace-icon {{ $marketplace['platform'] }}">
                            ...
                            <a href="https://www.tokopedia.com/hartono-m" target="_blank"
                                ...
                                <span class="marketplace-icon tokopedia">T</span>
                            </a>
                            <a href="https://shopee.co.id/hartono_motor" target="_blank"
                                class="bg-gray-100 hover:bg-gray-200 p-2 rounded-full transition-colors"
                                title="Beli di Shopee">
                                <span class="marketplace-icon shopee">S</span>
                            </a>
                            @endif
                        </div>
                    </div>
            ...
            @empty
            <!-- Fallback to hardcoded products if no database data -->
            <div
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
                ...
                <a href="{{ route('spare-parts.category', $category->slug) }}" class="text-center group cursor-pointer">
                    <div class="rounded-full p-4 mx-auto mb-3 w-16 h-16 flex items-center justify-center transition-colors"
                        ...
                        $defaultIcons = [
                        'oli-cairan' => 'M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6
                        0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26
                        ...
                        'transmisi' => 'M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003
                        ...
                        'aksesoris' => 'M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13
                        21l-2.286-6.857L5 12l5.714-2.143L13 3z',
                        'default' => 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2
                        0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10'
                        ];
