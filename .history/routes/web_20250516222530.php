...
// Custom route for Livewire file uploads only
// This route is specifically for handling file uploads in Docker environments
// It doesn't interfere with other Livewire functionality like login
