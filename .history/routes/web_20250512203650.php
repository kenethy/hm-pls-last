...
// Proxy route untuk Livewire file upload
Route::post('/admin/upload-file-proxy', [App\Http\Controllers\FileUploadProxyController::class, 'handle'])
    ->middleware(['web', 'auth'])
    ->name('livewire.upload-file-proxy');
