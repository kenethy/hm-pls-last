...
// WhatsApp Chat Manager Debug Route
Route::get('/admin/whatsapp-chat-manager-debug', function () {
    try {
        $page = new \App\Filament\Pages\WhatsAppChatManager();
        return response()->json([
            'status' => 'success',
...
})->middleware(['web', 'auth'])->name('admin.whatsapp-chat-manager.debug');
