...
Route::prefix('api/ratings')->group(function () {
    Route::get('/service/{serviceId}/modal', [App\Http\Controllers\MechanicRatingController::class, 'showRatingModal'])
        ->name('ratings.modal');
    Route::post('/submit', [App\Http\Controllers\MechanicRatingController::class, 'submitRating'])
        ->name('ratings.submit');
    Route::get('/service/{serviceId}', [App\Http\Controllers\MechanicRatingController::class, 'getServiceRatings'])
