...
Route::post('/custom-upload', [App\Http\Controllers\CustomFileUploadController::class, 'upload'])
    ->middleware(['web', 'auth'])
    ->name('custom.upload');

Route::post('/custom-upload-multiple', [App\Http\Controllers\CustomFileUploadController::class, 'uploadMultiple'])
    ->middleware(['web', 'auth'])
    ->name('custom.upload.multiple');

// Fallback route untuk menangani GET request ke livewire/upload-file
