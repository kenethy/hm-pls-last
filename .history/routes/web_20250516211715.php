...
// Custom Livewire file upload route
...
Route::post('/filament/upload-attachment', function () {
    return app(\Filament\Actions\CreateAttachment::class)->handle();
})->middleware(['web', 'auth'])->name('filament.upload-attachment');
