...
<body class="bg-gray-50 font-sans">
    ...
    <div class="bg-primary-600 text-white py-2 px-4 text-center no-print">
        <p>Laporan ini tersedia hingga: <span class="font-semibold">{{ $report->expires_at->format('d F Y') }}</span></p>
    </div>
    ...
    <div class="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <header class="flex flex-col md:flex-row justify-between items-center mb-8 border-b pb-6">
            <div class="flex items-center mb-4 md:mb-0">
                <img src="{{ asset('images/logo.png') }}" alt="Hartono Motor" class="h-16 mr-4">
                <div>
            ...
            <div class="text-right">
                ...
                <p class="font-mono font-semibold">{{ $report->unique_code }}</p>
            </div>
        </header>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead>
                            <tr>
                                ...
                                <th class="px-4 py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Titik Pemeriksaan</th>
                                <th class="px-4 py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Status</th>
                                <th class="px-4 py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Catatan</th>
                            </tr>
                        </thead>
                            ...
                            @foreach($report->checklistItems as $index => $item)
                                <tr>
                                    ...
                                    <td class="px-4 py-3 whitespace-nowrap">
                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full status-{{ $item->status }}">
                                            {{ $item->status_label }}
                                        </span>
                                    </td>
        ...
        <div class="flex flex-wrap justify-center gap-4 mb-8 no-print">
            <a href="{{ route('service-reports.download', $report->unique_code) }}" class="inline-flex items-center px-4 py-2 bg-primary-600 text-white rounded-md hover:bg-primary-700 transition">
            ...
            <button onclick="window.print()" class="inline-flex items-center px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700 transition">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a href="https://wa.me/?text={{ urlencode('Laporan servis kendaraan saya di Hartono Motor: ' . route('service-reports.show', $report->unique_code)) }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition">
